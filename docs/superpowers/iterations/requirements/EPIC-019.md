# EPIC-019 — Liebig bottleneck (build)

**Summary:** Liebig bottleneck (build)
**Stories:** STORY-0069, STORY-0070, STORY-0071, STORY-0072, STORY-0073, STORY-0074, STORY-0075
**Primary sources:** `spec/production.md`
**Status:** 0/7 done

## STORY-0069

**Epic:** EPIC-019 — Liebig bottleneck (build)
