...
def build(requirements_dir: Path, extract_path: Path, evidence_path: Path) -> str:
    ...
    lines = [
        ...
        "",
        "**Authoritative inputs:** `docs/plan/iterations/requirements/*.md`, `docs/plan/iterations/extract/requirements.json`, `docs/generated/evidence/target-scenarios.json`",
        "",
        "**Regeneration command:** `python3 docs/plan/iterations/build_roadmap.py --requirements-dir docs/plan/iterations/requirements --extract docs/plan/iterations/extract/requirements.json --evidence docs/generated/evidence/target-scenarios.json --output docs/generated/roadmap.md`",
        "",
        "## Generation boundary",
        "",
