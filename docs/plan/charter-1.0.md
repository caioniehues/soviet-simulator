...
| Transport and border | Minimal freight rail with three buildings, one locomotive type, and one wagon type; fixed-consist border purchase; multiple customs offices; all sixteen resources trade at fixed per-kind prices in one rouble; Water clears only through a physical metered border utility connection and never as cargo; one fixed 1950s–60s era and flat catalogue. |
