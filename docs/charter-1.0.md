...
| **R8** | The Land | B | Terrain T1: heightfield mesh + ray-marched cursor, `Terrain` sampler, road draping + grade gates, cut/fill earthworks, slope refusals, **procedural seed maps**, **ore-deposit siting**, minimal bridges, save v6. |
