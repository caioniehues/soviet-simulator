...
- Sort and min/max keys go through OrderedFloat, never `partial_cmp().unwrap()`. The crate
  already holds this line at 11 sites (polyline.rs:141, polyline3.rs:250,271, spline.rs:190,
  spline3.rs:92, polygon.rs:138,156,340, skeleton.rs:1263). A NaN key panics; an inconsistent
  comparator is a silent logic error; both are determinism breaks.
