...
- Validation must live where the invariant is CONSUMED. PROVEN: cereal production amount 0
  ...
  failures, `attempt to divide by zero` at money.rs:193 (market.rs:1127 divides by qty).
- The market unit tests run against thread-local fixtures (market.rs:1168, :1207) and do NOT
