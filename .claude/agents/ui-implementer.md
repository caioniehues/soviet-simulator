...
- UiWorld is an Any-keyed bag: the real interface is the 34 resource types registered in
  init.rs:35-73, and a wrong type is a runtime panic. Read a neighbouring panel first.
