...
- [SUBAGENTS HAVE NO LSP](gotcha-lsp-guard-starves-workers.md) — proven by probe 2026-08-27; never brief a worker to use or warm LSP; resolve symbols yourself and paste file:line
...
- [bd Executed-By convention deleted](gotcha-bd-executed-by-inert.md) — 1.2.2 hook inert; convention removed 2026-08-27, attribution is `--author` on comments
- [Opus everywhere](decision-opus-everywhere.md) — 2026-08-27: all rosters pin opus/high, supersedes sonnet-implements; gate stays mandatory
...
- [Consult memory before briefing](feedback-consult-memory-before-briefing.md) — a 2026-08-23 note held the answer I spent ~330k tokens rediscovering; probe the runtime, don't infer it from docs
