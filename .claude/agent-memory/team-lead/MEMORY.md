...
- [The LSP guard starves workers](gotcha-lsp-guard-starves-workers.md) — relent fix INSTALLED and works; per-cwd shared budget still stands; brief the read path when LSP is off
