...
use soviet_simulator::sim::commute::{CommutePhase, CommuteSimPlugin, CommuterPawn};
use soviet_simulator::sim::households::{HouseholdSimPlugin, RecruitmentPlan};
...
fn main() {
    ...
    app.add_plugins((
        ...
        LabourSimPlugin,
        VehicleSimPlugin,
        CommuteSimPlugin, // auto-adds Transit + Pathfinding + Traffic
    ));
